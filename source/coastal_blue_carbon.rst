...
The main output files for the main Coastal Blue Carbon model are located in the folder **Workspace/outputs_core**, and intermediate files in **Workspace/intermediate**. "Suffix" in the following file names refers to the optional user-defined Suffix input to the model.
...
- **net_present_value_[Suffix].tif**. Monetary value of carbon sequestration. Units: (Currency of Provided Price Table) per Hectare
