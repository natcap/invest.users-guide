...
#.  **Compute Econonomic Valuation (required)**:   This is a check box that ought to be selected if you would like to approximate a monentary value of your habitat and the loss in this value owing to habitat modification (reduction). ::
