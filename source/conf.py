...
project = u'InVEST'
copyright = u'2011, The Natural Capital Project'
...
htmlhelp_basename = 'MarineInVESTdoc'
...
latex_documents = [
  ('index', 'Marine_InVEST_Documentation_v2.0.b1.tex', u'InVEST Documentation (Marine)',
