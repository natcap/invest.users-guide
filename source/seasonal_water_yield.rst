...
**>>>>> Sorry, I broke the Data Sources section, working on fixing it <<<<<**
...
| Monthly precipitation                   | Global monthly precipitation data can be obtained from the WorldClim dataset: http://www.worldclim.org/                                                                                         |
|										  |                                                                                                                                                                                                 |              
|                                         | Alternatively, rasters can be interpolated from rain gauges with monthly data.                                                                                                                  |
+-----------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| Monthly reference evapotranspiration	  | Global monthly reference evapotranspiration may be obtained from the CGIAR CSI dataset (based on WorldClim data): http://www.cgiar-csi.org/data/global-aridity-and-pet-database.                |
