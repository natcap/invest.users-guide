...
InVEST 2.1 includes a mixture of Tier 0 and Tier 1 models. Tier 2 models for several services have been formulated and documented in a book just published by Oxford University Press (Natural Capital: The Theory & Practice of Mapping Ecosystem Services). We will design the Tier 2 software platform as a space where Tier 0, 1, 2 and 3 models can be integrated as appropriate for different applications.
